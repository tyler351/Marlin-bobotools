...
#define STRING_CONFIG_H_AUTHOR "(tkeeton)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "McPrintface 4.2.2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 212.22
  #define DEFAULT_bedKi 39.59
  #define DEFAULT_bedKd 758.33
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0.1, 0.1, 20 }
